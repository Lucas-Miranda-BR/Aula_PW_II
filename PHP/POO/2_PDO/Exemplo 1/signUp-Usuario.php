...
?>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-4 d-flex justify-content-center align-items-center altura">
                <div class="card w-100 shadow d-flex justify-content-center align-items-center flex-column">
                    ...
                    <div class="card-body">
                        <form action="signUp-Usuario.php" method="post">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <p>Já possui conta? <a href="./logIn-Usuario.php">Realize o Login</a></p>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <?php 
        ...
        echo `<div class="alert alert-primary">`;
          echo $newUsuario->insert($_POST['nome'], $_POST['email'], $_POST['senha'], $_POST['confirmar_senha'], '');
        echo `</div>`;
    ?>
